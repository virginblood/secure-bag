...
// MainnetBootnodes lists bootstrap nodes for the Phoenix main network. The
// slice is intentionally empty so nodes do not automatically connect to
// external Ethereum networks.
